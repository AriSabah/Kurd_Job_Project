...
const Hero = () => {
  return (
    <motion.div className="hero bg-neutral" animate="animate" initial="initial" variants={heroAnimation.backgroundAnimation}>
      <div className="hero-content flex-col lg:flex-row pb-0 pt-12 relative">
        <Stars />
        <motion.img src="a1.png" className="max-w-sm rounded-lg" animate="animate" initial="initial" variants={heroAnimation.imgAnimation} />
        <motion.div className="pb-5" animate="animate" initial="initial" variants={heroAnimation.textAnimation}>
